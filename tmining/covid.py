...
class CovidJsonParser(object):
    ...
    def __init__(self, columns=['nota','Q35805','Q344873']):
        # TODO: add 'fecha' as second column and all symptoms
        super(CovidJsonParser, self).__init__()
        self.canonical_symptnames = {'Q35805':'tos','Q344873':'dificultad respiratoria'}
        self.cols = columns
    ...
    def as_csv_row(self, MedNote_file, sep="\t"):
        ...
        # detect presence/abscence of self.cols
        # ...
