...
class CovidJsonParser(object):
    ...
    def __init__(self, symptcols=['Q38933','Q344873']):
    ...
    def as_csv_row(self, MedNote_file, sep="\t"):
        ...
        presence_or_absence = [(symptom in medical_register['síntomas']) for symptom in self.symptcols]
